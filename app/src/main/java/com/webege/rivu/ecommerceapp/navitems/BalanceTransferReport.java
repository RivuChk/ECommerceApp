 ...
 */
public class BalanceTransferReport extends Fragment implements OnClickListener {

    public static BalanceTransferReport instance;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.bal_trnsfr_report);
